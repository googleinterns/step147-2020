...
import com.google.sps.servlets.PusherAPI;
import com.pusher.rest.Pusher;
/** Servlet that holds the messages that a user has */
@WebServlet("/messages")
public class MessageServlet extends HttpServlet {
   // HttpRequest that returns the messages that a user has either sent, or received. Messaged include the original and translated messages.
   @Override
   ...
   // Servlet creates a new chatroom if none is present. It also creates a new message entity and stores it in the database.
   @Override
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
       ...
       if(chatroomID.equals("")){
           ...
           Chatroom newChatroom = new Chatroom(chatroomID, newMessage.senderId, newMessage.recipientId);
           newChatroom.setEntity();
       }
      
       // Query the user and retrieve the language of the recipient.
       Query userQuery = new Query("user");
       userQuery.setFilter(new Query.FilterPredicate("userId", Query.FilterOperator.EQUAL, newMessage.recipientId));
       ...
       Translation translation = translate.translate(newMessage.text, Translate.TranslateOption.targetLanguage(lang));
